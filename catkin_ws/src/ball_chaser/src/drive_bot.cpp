...
bool handle_drive_request(ball_chaser::DriveToTarget::Request& req, 
	...
	ROS_INFO("DriveToTarget request received - linear.x: %1.2f,  angular.z: %1.2f", 
	...
	// Set wheel velocities to requested ones
	...
	res.msg_feedback = "DriveToTarget set - linear.x" + std::to_string(motor_command.linear.x) 
